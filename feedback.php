...
<h2 align="center" style="font-family:'typo'; color:white">FEEDBACK/CONTACT SUPPORT</h2>
...
<div class="col-md-12">
  ...
  <div class="form-group"> 
    <textarea rows="5" cols="5" name="feedback" class="form-control" placeholder="Your message here..."></textarea>
  </div>
