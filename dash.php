...
if($rowcount == 0){
	...
	<td><b><a href="edit.php" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Edit</b></span></a></b></td></tr>';
}
else
{
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td>Edit</td> <td>Delete</td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
  ...
  <td><a title="Edit User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-book edit" aria-hidden="true"></span></b></a></td>
  <td><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash delete" aria-hidden="true"></span></b></a></td>
  </tr>';
}
$c=0;
echo '</table></div></div>';
